...
import type { LaneStylePart, LaneTheme } from '@/utils/themeTypes';
import type { CanvasInfo } from '@/store/editor';

import type Fraction from './fraction';
import type { Coord, Rect } from './scoreTypes';
...
export default class CanvasUtil {
  ...
  static getCanvasUtil(canvas: HTMLCanvasElement) {
